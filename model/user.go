...
type User struct {
	Id               int     `json:"id"`
	Username         string  `json:"username" gorm:"unique;index" validate:"max=32"`
	Password         string  `json:"password" gorm:"not null;" validate:"min=8,max=32"`
	OriginalPassword string  `json:"original_password" gorm:"-:all"` // this field is only for Password change verification, don't save it to database!
	DisplayName      string  `json:"display_name" gorm:"index" validate:"max=32"`
	...
	AffCode          string  `json:"aff_code" gorm:"type:varchar(32);column:aff_code;uniqueIndex"` // 自身 邀请码 （http传入参数时则是邀请人的邀请码）
	AffCount         int     `json:"aff_count" gorm:"type:int;default:0;column:aff_count"`
	AffQuota         int     `json:"aff_quota" gorm:"type:int;default:0;column:aff_quota"`               // 邀请剩余额度
	AffHistoryQuota  int     `json:"aff_history_quota" gorm:"type:int;default:0;column:aff_history"`     // 邀请历史额度
	InviterId        int     `json:"inviter_id" gorm:"type:int;column:inviter_id;index"`                 // 邀请人的ID
...
func (user *User) Edit(updatePassword bool) error {
	...
	updates := map[string]interface{}{
		...
		"max_concurrent_sessions": newUser.MaxConcurrentSessions,
	}
	if updatePassword {
